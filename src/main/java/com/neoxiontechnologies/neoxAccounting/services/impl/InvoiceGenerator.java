...
public class InvoiceGenerator {
	...
	public static void main(String[] args) {
		String pdfFilename = "d:/tmp/1/Invoice_Ex.pdf";
	...
	private void createPDF(String pdfFilename) {
		...
		try {
			...
			Image image = Image.getInstance(
					"D:\\Nizar\\Work\\neoxionTechnologies\\neox_accounting\\neox_accounting_backend\\src\\main\\resources\\logo.jpg");// Header
																																						// Image
			...
			fs.addFont(font);
			Phrase billz = fs.process("Bill To"); // customer information
